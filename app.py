...
# app.py - Backend Flask con Sistema Completo + Video Fix + ENDPOINT CORSI FISSI + UPLOAD IMMAGINI CORSO + I MIEI CORSI
# ========================================
...
def get_my_courses():
    ...
    try:
        ...
        # Aggiungi anche i corsi che l'utente insegna (se è instructor)
        taught_courses = []
        if user.is_admin:
...
if __name__ == '__main__':
    ...
    print(f"📚 I MIEI CORSI API: /api/me/courses e /api/me/enrollments ATTIVI!")
